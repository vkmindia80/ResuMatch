              ...
              >
                {generating ? (
                  <span className="flex items-center">
                    ...
                    {generationMode === 'optimize' ? 'Optimizing for Perfect Match...' : 'Generating & Optimizing...'}
                  </span>
                ) : (
                  generationMode === 'optimize' ? '🎯 Optimize for Perfect ATS Match' : '✨ Generate & Optimize Resume'
                )}
              </button>
            </div>
          </form>
